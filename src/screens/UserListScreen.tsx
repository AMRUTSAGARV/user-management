...
const HomeScreen = () => {
  ...
  const { users, isLoading, page } = useSelector(
  ...
  // to load the users with pagination
  ...
  const refreshUsers = async () => {
    ...
    if (isOffline) {
      ...
      return; // to Do nothing if offline
    }
    dispatch(resetUsers());
  ...
  return (
    ...
    >
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <View>
              ...
              <Text style={[styles.country, { color: theme.text }]}>
        ...
        onEndReachedThreshold={0.5} // it trigger when 50% of the remaining list is visible
        refreshControl={
          <RefreshControl
